...
public class MainActivity extends Activity
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btn_gonext).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(MainActivity.this,Upimg2Activity.class));
            }
        });
      ...
      //  mWebView.loadUrl("http://192.168.0.187:8080/member/credit/saveCredit.xhtm");
    }
            ...
            case REQUEST_CODE_PICK_IMAGE: {
                try {
                    if (Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP) {
                        ...
                        Log.e(TAG,"LOLLIPOP ---sourcePath>---lujing------>  "+sourcePath+"\r\n----new File(sourcePath).exists();----->  "+exists);
                        ...
                        Log.e(TAG,"-----uri.fromFile is going----> ");
                    }
                } catch (Exception e) {
                    e.printStackTrace();
                }
    ...
    private void fixDirPath() {
        String path = ImageUtil.getDirPath(MainActivity.this);

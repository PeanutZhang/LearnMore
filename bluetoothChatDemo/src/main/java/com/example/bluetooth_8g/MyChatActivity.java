			...
			public void onItemClick(AdapterView<?> arg0, View arg1,
				...
				try {
					...
					if (bluetoothDevice.getBondState() == BluetoothDevice.BOND_NONE) {
						...
						// 跳转界面，开始聊天
						Intent intent = new Intent(MyChatActivity.this,
								com.example.bluetooth_8g.chat.MyChatActivity.class);
		...
		public void onReceive(Context context, Intent intent) {
			...
			if (action.equals(BluetoothDevice.ACTION_FOUND)) {
				...
				case BluetoothDevice.BOND_NONE:
					Toast.makeText(MyChatActivity.this, "配对失败", 0).show();
					break;
				case BluetoothDevice.BOND_BONDING:
					Toast.makeText(MyChatActivity.this, "正在配对", 0).show();
					break;
				case BluetoothDevice.BOND_BONDED:
					Toast.makeText(MyChatActivity.this, "配对成功", 0).show();
					// 在集合中移除
